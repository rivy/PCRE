...
::
::set "project_props=%project_props% -D PCRE2_LINK_SIZE:STRING=4" &:: internal link size (2 = 64k compiled pattern; 3 = ...)
...
::set "project_props=%project_props% -D PCRE2GREP_BUFSIZE:STRING=51200" &:: internal buffer size (???) (default == 20480)
set "project_props=%project_props% -D PCRE2_NEWLINE:STRING=ANYCRLF" &:: EOLN matching (default == LF)
